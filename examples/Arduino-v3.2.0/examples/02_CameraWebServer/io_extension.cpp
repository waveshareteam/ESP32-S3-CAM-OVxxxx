...
void IO_EXTENSION_Init()
{
    ...
    DEV_I2C_Set_Slave_Addr(IO_EXTENSION_ADDR);
    ...
    IO_EXTENSION.Last_io_value = 0; // All pins are initially set to high (output mode)
...
uint8_t IO_EXTENSION_Input(uint8_t pin) 
{
    ...
    DEV_I2C_Read_Nbyte( IO_EXTENSION_IO_INPUT_ADDR, &value, 1);
