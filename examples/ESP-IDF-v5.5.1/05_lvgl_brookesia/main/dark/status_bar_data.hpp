...
constexpr ESP_Brookesia_StatusBarAreaData_t ESP_BROOKESIA_PHONE_284_240_DARK_STATUS_BAR_AREA_DATA(int w_percent, ESP_Brookesia_StatusBarAreaAlign_t align)
{
    return {
...
constexpr ESP_Brookesia_StatusBarData_t ESP_BROOKESIA_PHONE_284_240_DARK_STATUS_BAR_DATA()
{
    return {
        .main = {
        ...
        .area = {
            .num = 2,
            .data = {
                ESP_BROOKESIA_PHONE_284_240_DARK_STATUS_BAR_AREA_DATA(50, ESP_BROOKESIA_STATUS_BAR_AREA_ALIGN_START),
                ESP_BROOKESIA_PHONE_284_240_DARK_STATUS_BAR_AREA_DATA(50, ESP_BROOKESIA_STATUS_BAR_AREA_ALIGN_END),
            },
        },
