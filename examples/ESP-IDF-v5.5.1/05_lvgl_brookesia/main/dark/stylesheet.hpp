...
constexpr ESP_Brookesia_PhoneHomeData_t ESP_BROOKESIA_PHONE_284_240_DARK_HOME_DATA()
{
    return {
        .status_bar = {
            .data = ESP_BROOKESIA_PHONE_284_240_DARK_STATUS_BAR_DATA(),
            .visual_mode = ESP_BROOKESIA_STATUS_BAR_VISUAL_MODE_SHOW_FIXED,
        },
        .navigation_bar = {
            .data = ESP_BROOKESIA_PHONE_284_240_DARK_NAVIGATION_BAR_DATA(),
            .visual_mode = ESP_BROOKESIA_NAVIGATION_BAR_VISUAL_MODE_HIDE,
        },
        .app_launcher = {
            .data = ESP_BROOKESIA_PHONE_284_240_DARK_APP_LAUNCHER_DATA(),
            .default_image = ESP_BROOKESIA_STYLE_IMAGE(&esp_brookesia_image_small_app_launcher_default_98_98),
        },
        .recents_screen = {
            .data = ESP_BROOKESIA_PHONE_284_240_DARK_RECENTS_SCREEN_DATA(),
...
constexpr ESP_Brookesia_PhoneManagerData_t ESP_BROOKESIA_PHONE_284_240_DARK_MANAGER_DATA()
{
    return {
        .gesture = ESP_BROOKESIA_PHONE_284_240_DARK_GESTURE_DATA(),
...
constexpr ESP_Brookesia_PhoneStylesheet_t ESP_BROOKESIA_PHONE_284_240_DARK_STYLESHEET()
{
    return {
        .core = ESP_BROOKESIA_PHONE_284_240_DARK_CORE_DATA(),
        .home = ESP_BROOKESIA_PHONE_284_240_DARK_HOME_DATA(),
        .manager = ESP_BROOKESIA_PHONE_284_240_DARK_MANAGER_DATA(),
    };
}
