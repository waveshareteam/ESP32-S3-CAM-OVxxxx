...
constexpr ESP_Brookesia_GestureIndicatorBarData_t ESP_BROOKESIA_PHONE_284_240_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA()
{
    return {
        .main = {
...
constexpr ESP_Brookesia_GestureIndicatorBarData_t ESP_BROOKESIA_PHONE_284_240_DARK_GESTURE_BOTTOM_INDICATOR_BAR_DATA()
{
    return {
        .main = {
...
constexpr ESP_Brookesia_GestureData_t ESP_BROOKESIA_PHONE_284_240_DARK_GESTURE_DATA()
{
    return {
        .detect_period_ms = 20,
        .threshold = {
        ...
        .indicator_bars = {
            ...
            ESP_BROOKESIA_PHONE_284_240_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA(),
            [ESP_BROOKESIA_GESTURE_INDICATOR_BAR_TYPE_RIGHT] =
            ESP_BROOKESIA_PHONE_284_240_DARK_GESTURE_LEFT_RIGHT_INDICATOR_BAR_DATA(),
            [ESP_BROOKESIA_GESTURE_INDICATOR_BAR_TYPE_BOTTOM] =
            ESP_BROOKESIA_PHONE_284_240_DARK_GESTURE_BOTTOM_INDICATOR_BAR_DATA(),
        },
        .flags = {
