...
constexpr ESP_Brookesia_RecentsScreenSnapshotData_t ESP_BROOKESIA_PHONE_284_240_DARK_RECENTS_SCREEN_SNAPSHOT_DATA()
{
    return {
...
constexpr ESP_Brookesia_RecentsScreenData_t ESP_BROOKESIA_PHONE_284_240_DARK_RECENTS_SCREEN_DATA()
{
    return {
        .main = {
            .y_start = 0,
        ...
        .snapshot_table = {
            ...
            .snapshot = ESP_BROOKESIA_PHONE_284_240_DARK_RECENTS_SCREEN_SNAPSHOT_DATA(),
        },
        .trash_icon = {
