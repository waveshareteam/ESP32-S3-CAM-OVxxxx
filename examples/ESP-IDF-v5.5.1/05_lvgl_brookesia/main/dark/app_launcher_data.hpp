...
constexpr ESP_Brookesia_AppLauncherIconData_t ESP_BROOKESIA_PHONE_284_240_DARK_APP_LAUNCHER_ICON_DATA()
{
    return {
        .main = {
...
constexpr ESP_Brookesia_AppLauncherData_t ESP_BROOKESIA_PHONE_284_240_DARK_APP_LAUNCHER_DATA()
{
    return {
        .main = {
            .y_start = 0,
        ...
        .icon = ESP_BROOKESIA_PHONE_284_240_DARK_APP_LAUNCHER_ICON_DATA(),
        .flags = {
