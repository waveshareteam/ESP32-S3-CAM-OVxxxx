...
constexpr ESP_Brookesia_CoreHomeData_t ESP_BROOKESIA_PHONE_284_240_DARK_CORE_HOME_DATA()
{
    return {
        .background = {
            .color = ESP_BROOKESIA_STYLE_COLOR(0x1A1A1A),
            .wallpaper_image_resource = ESP_BROOKESIA_STYLE_IMAGE(&esp_brookesia_image_small_wallpaper_dark_240_240),
        },
        .text = {
...
constexpr ESP_Brookesia_CoreManagerData_t ESP_BROOKESIA_PHONE_284_240_DARK_CORE_MANAGER_DATA()
{
    return {
        .app = {
            .max_running_num = 3,
...
constexpr const char *ESP_BROOKESIA_PHONE_284_240_DARK_CORE_INFO_DATA_NAME = "284x240 Dark";
constexpr ESP_Brookesia_CoreData_t ESP_BROOKESIA_PHONE_284_240_DARK_CORE_DATA()
{
    return {
        .name = ESP_BROOKESIA_PHONE_284_240_DARK_CORE_INFO_DATA_NAME,
        .screen_size = ESP_BROOKESIA_STYLE_SIZE_RECT(284, 240),
        .home = ESP_BROOKESIA_PHONE_284_240_DARK_CORE_HOME_DATA(),
        .manager = ESP_BROOKESIA_PHONE_284_240_DARK_CORE_MANAGER_DATA(),
    };
}
