...
extern "C" void app_main(void)
{
    ...
    /* Install apps */
    PhoneCameraConf *app_camera_conf = new PhoneCameraConf(0,0);
    ESP_BROOKESIA_CHECK_NULL_EXIT(app_camera_conf, "Create app setting failed");
    ESP_BROOKESIA_CHECK_FALSE_EXIT((phone->installApp(app_camera_conf) >= 0), "Install app camera failed");
