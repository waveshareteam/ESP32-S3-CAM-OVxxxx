...
static esp_err_t set_hflip_with_stream_restart(web_cam_video_t *video, uint8_t enable);
...
esp_err_t bsp_io_expander_init(void)
{
    ...
    i2c_master_get_bus_handle(CONFIG_EXAMPLE_SCCB_I2C_PORT_INIT_BY_APP, &i2c_handle);

    ret = custom_io_expander_new_i2c_ch32v003(i2c_handle, CUSTOM_IO_EXPANDER_I2C_CH32V003_ADDRESS, &io_expander);
